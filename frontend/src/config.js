...
const config = {
  ...
  production: {
    apiUrl: 'https://your-api-domain.com' // Replace with your deployed API URL
  }
};
...
// ================================================================
// frontend/src/App.jsx (Updated with real API integration)
// ================================================================
              ...
              <div>
                ...
                <div className="ml-8 space-y-2">
                  {result.headings.length > 0 ? (
                    ...
                    <p className="text-gray-500 italic">No headings detected in this document</p>
                  )}
                </div>
              </div>
            </div>
...
// ================================================================
// Testing the API with curl (for backend testing)
// ================================================================
